	 ...
	 <div class="col-sm-12 space_all">
	  ...
	  <div class="col-sm-4">
	   <div class="contact_1ir clearfix">
		...
		<h5 class="col"><i class="fa fa-map-marker"></i> 6th Floor ABC Place, Waiyaki Way</h5>
		<h5 class="col"><i class="fa fa-phone"></i> +254712345678</h5>
		<h5 class="col"><i class="fa fa-envelope"></i> perfectrealty@gmail.com</h5>
		<h5 class="col"><i class="fa fa-clock-o"></i> 8:00 a.m - 6:00 p.m</h5>
	   </div>
	  </div>
	 </div>
   </div>
