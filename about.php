   ...
   <div class="about_1 clearfix">
    <div class="col-sm-6">
     <div class="about_1l clearfix">
	  <h4 class="mgt">ABOUT <span class="col_1">PERFECT REALTY</span></h4>
	  <p>Perfect Realty is a full service investment and advisory firm advising clients on their Real Estate strategies.
		  We are recognized real estate consultants in Nairobi, Kenya, delivering the insights and experience needed to
		  help private and institutional clients to achieve their real estate investment objectives. Our consulting is guided by regulations of Estate Agents Act, 1984 CAP 533 Laws of Kenya, under which our principals are registered and fully insured.</p>
	  <p>We always strives to provide clients with exemplary services in a transparent and professional way, to provide
		  employees unparalleled opportunities for personal and professional development, and to provide partners and investors with maximized real estate asset value. We understand that our customers define the standard of quality and service, and their loyalty must be earned.</p>
	  <h5><a class="button" href="#">READ MORE</a></h5>
	 </div>
	</div>
	<div class="col-sm-6">
     <div class="about_1r clearfix">
	  <img src="img/about1.jpg" class="iw" alt="abc">
	 </div>
	</div>
   </div>
  </div>
